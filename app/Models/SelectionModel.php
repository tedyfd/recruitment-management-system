...
class SelectionModel extends Model
{
    ...
    public function getAllSelections(){        
        return $this->query("SELECT selection.*, selection_status.selection, selection_status.description FROM selection
    ...
    public function getAllSelectionByApplicantId($id){        
        return $this->query("SELECT selection.*, selection_status.status, selection_status.description FROM selection
